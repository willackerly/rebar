...
| [rebar-compliance-audit](subagent-prompts/rebar-compliance-audit.md) | Full REBAR compliance assessment (v3-aware) — structural, content accuracy, enforcement, session lifecycle | High | single or fan-out |
