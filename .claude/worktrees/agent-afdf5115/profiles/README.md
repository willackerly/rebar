...
1. Find the profile that best matches your project
2. Follow its checklist for which files to copy and customize
3. Skip sections it marks as "N/A" or "Optional"
4. If your project spans multiple profiles (e.g., a monorepo with a
