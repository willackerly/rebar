# ask — shell interface for agent queries

A Unix-like CLI for interacting with role-based agents. Implements the
[ASK-SHELL.md](../ASK-SHELL.md) proposal (v0: bash proof-of-concept).
